...
-- - Adding game over and victory states
...
--  Adding player death state and victory state
...
gSounds = {
	...
	--  VictoryState and GameOverState background music
...
gTextures = {
	...
	-- - adding poles and flags. Same file needs to load twice because of how GameObject is written
...
-- Easy printing of text. Storing local variables for readability
